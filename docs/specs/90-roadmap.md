...
3. **M3, parameterized templates:** named, versioned, pinned, data-only template initialization from [template initialization](03-template-init.md) is implemented. M4 workspace reconciliation is also implemented; M5 and M6 remain planned.
